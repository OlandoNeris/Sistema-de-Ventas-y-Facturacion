...
<body background="img/PizzaBack.jpg">
	...
	<div class="container col-8" id="aperturaCierreForm">
		<div class="row">
			<div class="alert alert-primary col-6 col  " role="alert">
				<button type="button" class="btn btn-outline-success btn-lg col align-self-center  ">Abrir Caja</button>
			</div>

			<div class="alert alert-primary col-6 col align-items-center" role="alert">
				<button type="button" class="btn btn-outline-danger btn-lg col align-self-center">Cerrar Caja</button>
			</div>
	...
	<div class="container col-10" id="DatosUsuarioCaja">
		<div class="row">
			<div class="alert alert-primary col-6 " role="alert">
				<label style="text-align:center;" class="col align-self-center" for="numeroCaja">Numero de Caja</label>
				<label style="text-align:center;" class="col align-self-center" for="numeroCaja">134</label>
			</div>

			<div class="alert alert-primary col-6 col" role="alert">
				<label style="text-align:center;"  class="col align-self-center">Usuario</label>
				<label style="text-align:center;" class="col align-self-center" >Juan Perez</label>
			</div>

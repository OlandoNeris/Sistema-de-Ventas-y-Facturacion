<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$query = mysqli_query($conn,"SELECT f.nofactura, DATE_FORMAT(f.fecha, '%d/%m/%Y') as fecha, DATE_FORMAT(f.fecha,'%H:%i:%s') as  hora, f.codcliente, f.estado,
												 v.nombre as vendedor,
												 v.apellido as vendedorAp,
												 cl.dni_cliente, cl.nombre, cl.telefono,cl.direccion
											FROM factura f
